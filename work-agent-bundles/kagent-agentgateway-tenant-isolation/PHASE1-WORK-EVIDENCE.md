...
| Item | Why |
|---|---|
| Entra ID issuer, app registrations, API scopes, A2A and MCP app roles | Red has no workplace Entra tenant. `E01` shows the JWKS backend and five JWT policies pass server-side schema validation only |
