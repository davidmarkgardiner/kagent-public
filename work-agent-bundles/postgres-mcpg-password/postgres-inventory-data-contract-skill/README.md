# MCPg password-bundle PostgreSQL inventory data-contract skill
...
This skill belongs only to the MCPg read-query path. Passwordless Entra/UAMI
deployment belongs only to the separate `postgres-fastmcp-entra-uami` bundle.
