...
| 1b. Make the pinned runsc asset reachable | [`agent-substrate/runsc-asset/PACKAGE-AND-PRESEED.md`](agent-substrate/runsc-asset/PACKAGE-AND-PRESEED.md) | Blocks actor boot with no `gs://` egress. Package the binary in an image, pre-seed via DaemonSet. Proven 2026-09-23/24 |
