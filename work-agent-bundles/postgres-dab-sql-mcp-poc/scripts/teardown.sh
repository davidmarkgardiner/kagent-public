...
kubectl --context "$context" -n kagent delete agent/postgres-compliance-lab-agent --ignore-not-found
kubectl --context "$context" -n kagent delete remotemcpserver/postgres-compliance-readonly-mcp --ignore-not-found
