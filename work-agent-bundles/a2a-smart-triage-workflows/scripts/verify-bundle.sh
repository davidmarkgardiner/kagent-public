...
for rel in FRONT-SHEET.md WORK-AGENT-START-PROMPT.md CHECKLIST.md FINAL-DEMO-WALKTHROUGH.md requests/a2a-smart-triage-request.yaml prompts/01-prove-a2a-fanout.md prompts/02-final-demo-walkthrough.md payload/REFERENCE.md evidence/EVIDENCE-TEMPLATE.md; do
