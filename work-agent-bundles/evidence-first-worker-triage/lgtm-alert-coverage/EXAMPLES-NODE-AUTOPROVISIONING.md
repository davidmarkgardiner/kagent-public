...
This sheet focuses on AKS Node Auto-Provisioning (NAP), scheduling and evictions. It complements [LGTM Alert Coverage Baseline](LGTM-ALERT-COVERAGE-BASELINE.md) and the [AKS Node Auto-Provisioning Platform Guide](../../docs/platform-kb/aks/node-auto-provisioning.md).
...
Use a named tier-1 workload alert in addition to the fleet ratio, with a duration based on the platform provisioning SLO.

~~~logql
# Candidate: FailedSchedulingEvents
