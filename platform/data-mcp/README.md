...
The preferred first implementation is **read-only SQL through DAB**, using database views or stored procedures that expose a small, useful reporting contract. It is more predictable and auditable than giving an LLM raw SQL, connection strings, or broad database credentials.
